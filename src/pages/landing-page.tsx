...
const LandingPage: React.FC = () => {
  ...
  }, [actions, state.loading, state.popularStocks.length]);
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      window.location.href = `/stocks?search=${encodeURIComponent(
        searchQuery
      )}`;
    }
  };
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
            Get live stock prices, interactive charts, and comprehensive market
            data. Built as a Progressive Web App for the ultimate mobile and
            desktop experience.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Most tracked stocks updated in real-time
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Built with modern web technologies to deliver a native app
              experience
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Live stock prices and charts that update every few seconds using
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Install on any device for a native app experience with offline
                capabilities
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Detailed stock information, interactive charts, and advanced
                filtering options
              </p>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-sm">
            © 2025 StockTracker. This is a demo application for educational
            purposes.
          </p>
        </div>
      </footer>
